...
class ReflectionClass extends \ReflectionClass implements IMetaData, LoggerAwareInterface {
    ...
    public function __construct($name, FileInfo $fileInfo)
    {
        ...
        if (($parentClass = $this->getParentClass())) {
            ...
            $reflexParent = ReflectionFactory::factory('Lime\Reflection\ReflectionClass',
    ...
    public function getMethods($filter = null)
    {
        if (is_null($this->methods)) {
            ...
            foreach ($methods as $method) {
                ...
                $reflexMethod = ReflectionFactory::factory('Lime\Reflection\ReflectionMethod',
    ...
    {
        return $this->getMethodsByVisibility(\ReflectionMethod::IS_PUBLIC,
                        $showInherited);
    }
    /**
    ...
    {
        return $this->getMethodsByVisibility(\ReflectionMethod::IS_PROTECTED,
                        $showInherited);
    }
    /**
